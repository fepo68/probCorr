%% Unsupervised Clustering Matching Via LVM - NON LINEAR VERSION
...
for t = 1:T
    ...
    [ap,bp,mu_j,invCj] = equation4IWataNL(X,S,W,params);
    params.ap = ap;
    params.bp = bp;
    params.mu_j = mu_j;
    params.invCj = invCj;
...
%                 prodC_j;
            ...
            [params.ap_no_dn,params.bp_no_dn,params.mu_j_no_dn,params.invCj_no_dn] = ...
                equation13IWata_excluding_dnNL(X,S,W,params,d,n);
            ...
            for j = 1:numOfClasses
                [ap_sdn_j,bp_sdn_j,mu_j_sdn_j,invCj_sdn_j] = ...
                    equation13IWata_sdn_jNL(X,S,W,params,d,n,i);
            ...
            xdn = X{d}(n,:);
            probNew = probEq13NewClusterNL(params,W,X,d,n); %%%% voy AQUI
            % Eq 14 - iwata
